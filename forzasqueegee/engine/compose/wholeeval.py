...
# 15~16인 단위로 접은 값 (2026-09-03, 사람 판 26벌).
#
# 재료 자의 상자는 **면 도색 상자**다 (`ruler.paint_boxes` — 설치 파일의 유닛
# 상자, 사람 판은 헤더의 차 id로 찾는다). 레이어 뻗음의 백분위 상자로 재던
# 때(big_n 중앙 12.25)보다 큰 색면 문턱이 높아져 중앙이 6으로 내려왔다 — 로고
# 줄·글자가 상자를 늘려 문턱을 흔들던 것이 사라진 값이다.
#
# `colors`는 작가 하나(Tohru, 옆면 2,400색)가 p95를 800으로 끌어 올린다 —
# p90 242까지가 실제 범위고 우리 795는 그 밖이다.
MATERIAL_PRIOR: dict[str, tuple] = {
    "big_n": (2.35, 2.7, 4, 6, 10.5, 12.6, 13.3),
    "big_cols": (1.35, 1.7, 2, 3, 4.5, 5.6, 6.3),
    "hero_share": (0.1745, 0.2075, 0.3139, 0.3973, 0.4915, 0.5151, 0.5988),
    "objects": (0, 0, 0.375, 1, 1.375, 2.45, 3.125),
